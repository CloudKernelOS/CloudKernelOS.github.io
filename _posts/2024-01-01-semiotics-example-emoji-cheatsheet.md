---
layout: post
title:  "Semiotics and emojis as an example of communication shorthand"
date:   2024-01-01 4:30:00
categories: template
---


CloudKernelOS will be based on communication shorthand between different nodes of a swarm robotics cloud.

Emojis are an example of how MUCH we can communicate with VERY little data exchange ... in order to mentally reinforce the discipline of minimalist data exchange, we will, as a development community attempt to rely upon emojis for communicating our human emotions ... doing this will also furnish us insights in minimalist communication based on a shared vocabulary of symbols and signs.

The cheatsheet below can of course be readily forked, expanded upon, annotated and generally improved.
